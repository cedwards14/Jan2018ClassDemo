...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        ...
        <asp:ListView ID="AlbumTracks" runat="server" DataSourceID="AlbumTracksODS" OnItemCommand="AlbumTracks_ItemCommand">
            ...
            <AlternatingItemTemplate>
                <tr style="background-color: #990000;">
                    ...
                    <td>
                       ...
                       <td>
                  <asp:Button ID="SupaButton" runat="server" Text="PICK!?!?!" CommandName="Select" CommandArgument='<%# Eval("TrackId") %>' />
                      </td>
            ...
            <EmptyDataTemplate>
                <table runat="server" style="background-color: #005900; border-collapse: collapse; border-color: #999999; border-style: none; border-width: 1px;">
                    <tr>
            ...
            <ItemTemplate>
                <tr style="background-color: #005900; color: #000000;">
                    <td>
                        <asp:Label Text='<%# Eval("TrackId") %>' runat="server" ID="TrackIdLabel" /></td>
                    <td>
                        <asp:Label Text='<%# Eval("Name") %>' runat="server" ID="NameLabel" /></td>
        ...
        <asp:ObjectDataSource ID="AlbumTracksODS" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="Tracks_GetByAlbumID" TypeName="ChinookSystem.BLL.TrackController">
