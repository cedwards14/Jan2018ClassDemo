...
<div>
   ...
   <div class="row"> <%--Start error handling--%>
       <div class="col-sm-12">
    ...
    <div class="col-sm-2">
        ...
        <asp:DropDownList ID="ArtistDDL" runat="server"
            Width="150px" DataSourceID="ArtistDDLODS" DataTextField="DisplayText" DataValueField="IDValueField">
        </asp:DropDownList><br />
        ...
        <asp:DropDownList ID="MediaTypeDDL" runat="server"
            Width="150px" DataSourceID="MediaTypeDDLODS" DataTextField="DisplayText" DataValueField="IDValueField">
        </asp:DropDownList><br />
        ...
        <asp:DropDownList ID="GenreDDL" runat="server"
            Width="150px" DataSourceID="GenreDDLODS" DataTextField="DisplayText" DataValueField="IDValueField">
        </asp:DropDownList><br />
        ...
        <asp:DropDownList ID="AlbumDDL" runat="server"
            Width="150px" DataSourceID="AlbumDDLODS" DataTextField="DisplayText" DataValueField="IDValueField">
        </asp:DropDownList><br />
    ...
    <asp:ObjectDataSource ID="AlbumDDLODS" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="List_AlbumTitles" TypeName="ChinookSystem.BLL.AlbumController"></asp:ObjectDataSource>
    ...
    <asp:ObjectDataSource ID="TrackSelectionListODS" runat="server" 
        ...
        TypeName="ChinookSystem.BLL.TrackController"
         ...
         >
        <SelectParameters>
            <asp:ControlParameter ControlID="TracksBy" PropertyName="Text" Name="passedparameter" Type="String"></asp:ControlParameter>
